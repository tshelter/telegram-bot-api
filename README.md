...
`docker run -d -p 8081:8081 --name=telegram-bot-api --restart=always -v telegram-bot-api-data:/var/lib/telegram-bot-api -e TELEGRAM_API_ID=<api_id> -e TELEGRAM_API_HASH=<api-hash> tshipenchko/telegram-bot-api:latest`
...
services:
  telegram-bot-api:
    image: tshipenchko/telegram-bot-api:latest
    environment:
